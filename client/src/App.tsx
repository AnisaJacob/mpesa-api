...
import { CreditCard, History, Smartphone, Send, Building2, Wallet, QrCode } from 'lucide-react';

function App() {
  const [activeTab, setActiveTab] = useState<'c2b' | 'b2c' | 'b2b' | 'balance' | 'qr' | 'history'>('c2b');
  const [currentCheckoutRequestId, setCurrentCheckoutRequestId] = useState<string>('');
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">M-Pesa Payment Gateway</h1>
                <p className="text-gray-600">Secure payments with M-Pesa Daraja API</p>
              </div>
            </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {currentCheckoutRequestId || currentConversationId ? (
          <PaymentStatus
            checkoutRequestId={currentCheckoutRequestId || currentConversationId}
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Customer to Business payment using STK Push. Customer pays from their M-Pesa account.
              </p>
            </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Business to Customer payment. Send money from your business account to customer's M-Pesa.
              </p>
            </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Business to Business payment. Transfer funds between business accounts.
              </p>
            </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Generate M-Pesa QR codes for easy payments. Customers can scan to pay.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-gray-600">Powered by M-Pesa Daraja API</span>
            </div>
            <p className="text-sm text-gray-500">
              This is a demonstration application. Use test credentials for sandbox mode.
            </p>
          </div>
        </div>
      </footer>
